  ...
  return (
    <nav className="relative w-full z-50">
      ...
      <div className="w-full bg-white paddings h-14  flex items-center justify-between relative backdrop-blur-3xl">
        ...
        <div
          className={`flex flex-col md:flex-row justify-center items-center gap-5  md:h-full absolute top-14  md:top-0  md:py-0 right-0 md:relative w-full md:w-auto bg-secondary overflow-hidden md:bg-transparent backdrop-blur-3xl transition-all duration-300 ease-in-out md:translate-x-0 z-50 ${
