    ...
    <section className="h-fit w-full py-8 relative bg-cyan-950 my-20">
      ...
      <div className="relative flex justify-between flex-col md:flex-row gap-y-6 items-start paddings">
        <div className="text-white space-y-2">
          <h2 className="text-3xl font-bold capitalize">scholarship program</h2>
          <p className="text-xs text-opacity-65 w-[70%]">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium
            aspernatur id, sed sequi tempore numquam illum modi esse nisi quam.
          </p>
        </div>
        <button className="px-5 py-3 outline-none bg-secondary text-white font-semibold rounded capitalize text-sm flex gap-2 items-center">
          financial aid{" "}
          <span>
            <FaArrowRightLong />
          </span>
